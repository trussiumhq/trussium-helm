...
Runtime v0.35.0 can include provider metadata access in `/health/ready`. The
...
With runtime v0.35.0, the active provider span is propagated to supported
...
Runtime v0.35.0 writes bounded newline-delimited JSON events to standard
...
Runtime v0.35.0 adds public typed bases for Trussium-owned configuration,
...
Runtime v0.35.0 provides three independently importable Grafana dashboard JSON
...
[runtime dashboard guide](https://github.com/trussiumhq/trussium/blob/v0.35.0/docs/DASHBOARDS.md)
for import, provisioning, variables, privacy, and troubleshooting.

## Portable runtime alerts

Runtime v0.35.0 provides five portable Prometheus starter alerts for missing
