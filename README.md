...
Runtime v0.33.0 can make `/health/ready` reflect provider metadata access and,
...
[runtime health guide](https://github.com/trussiumhq/trussium/blob/v0.33.0/docs/HEALTH.md)
...
Runtime v0.33.0 propagates W3C `traceparent` and optional `tracestate` from the
...
Runtime v0.33.0 also emits newline-delimited structured operational JSON for
...
Runtime v0.33.0 adds a public typed hierarchy for Trussium-owned
...
[runtime exception guide](https://github.com/trussiumhq/trussium/blob/v0.33.0/docs/ERRORS.md)
for stable codes, catch boundaries, compatibility, and privacy rules.

Runtime v0.33.0 adds a typed asynchronous lifecycle contract for
...
[runtime lifecycle guide](https://github.com/trussiumhq/trussium/blob/v0.33.0/docs/LIFECYCLE.md)
for ordering, failure, cancellation, privacy, and extension boundaries.

Runtime v0.33.0 provides three portable Grafana dashboard JSON models in the
...
the [runtime dashboard guide](https://github.com/trussiumhq/trussium/blob/v0.33.0/docs/DASHBOARDS.md)
for artifacts, import methods, variables, privacy, and troubleshooting.

Runtime v0.33.0 also provides five portable Prometheus starter alerts for
...
[runtime alerting guide](https://github.com/trussiumhq/trussium/blob/v0.33.0/docs/ALERTING.md)
and the
[reference rules](https://github.com/trussiumhq/trussium/blob/v0.33.0/deploy/observability/prometheus/rules/trussium-runtime-alerts.yaml)
...
The complete Kind lifecycle test builds runtime `v0.33.0` from a neighboring
