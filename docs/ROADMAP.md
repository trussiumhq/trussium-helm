...
The production Helm chart now carries the validated Trussium v0.34.0
...
- Runtime v0.34.0 outbound W3C `traceparent` and optional `tracestate`
...
- Runtime v0.34.0 structured operational events for configuration, provider
...
- Runtime v0.34.0 portable Prometheus, Loki, and Tempo dashboard artifacts with
...
- Runtime v0.34.0 portable Prometheus starter alerts and operator runbooks for
...
- Runtime v0.34.0 dependency-aware readiness settings for opt-in provider
...
- Runtime v0.34.0 public exception hierarchy compatibility guidance without new
  chart values, templates, resources, or deployment behavior.
- Runtime v0.34.0 service lifecycle compatibility guidance for ordered startup,
  ...
  resources.
- Runtime v0.34.0 service registry compatibility guidance for explicit ordered
